...
We may optionally use an orthonormality penalty applied to the basis tensor. It is calculated as:
  ...
  <img src="https://github.com/user-attachments/assets/7d6f6113-33b7-4d01-a1c5-61a3218cebd4" height="600"/>

where B is the number of bases, and L_{ortho} is the calculated orthonormality penalty.
